...
Una vez que termine de desarrollar la documentacion necesaria, pensando en los posibles escenario comence a generar el set de datos para utilizar a la hora de diseñar los casos de prueba.
